        ...
        <div id="main-content">
            ...
            <div class="topic_container">
                ...
                <c:forEach var="topic" items="${requestScope.topicList}">
                    <div class="topic_item" onclick="window.location='topic?id=${topic.id}'">${topic.text} <span class="float_right topic_entry_time_text">U: ${topic.updatedAt} C: ${topic.createdAt}</span></div>
                </c:forEach>
            </div>
        </div>
    </body>
